# Generated by Powerlevel10k configuration wizard on 2023-04-20 at 17:13 PDT.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=7 # default 232
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=0 # default 7
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='decoy|kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|kubent'
  ...
  typeset -g POWERLEVEL9K_VPN_IP_BACKGROUND=8
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=7 # default 0
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=0 # default 7
